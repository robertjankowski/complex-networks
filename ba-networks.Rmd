...
clustering_avg_length <- 
  read.csv("output/ba_simulation_par_2_clustering.txt", header = FALSE, col.names = c("C", "N")) %>%
  left_join(read.csv("output/ba_simulation_par_2_avg_path.txt", header = FALSE, col.names = c("l", "N"))) %>%
